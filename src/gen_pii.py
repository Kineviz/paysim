...
def extract_pii():
    ...
    emails_df.to_csv(os.path.join(data_dir, 'emails.csv'), index=False)
    ...
    phones_df.to_csv(os.path.join(data_dir, 'phonenumbers.csv'), index=False)
    ...
    ssns_df.to_csv(os.path.join(data_dir, 'ssns.csv'), index=False)
    ...
    has_email.to_csv(os.path.join(data_dir, 'Has_Email.csv'), index=False)
    ...
    has_phone.to_csv(os.path.join(data_dir, 'Has_Phonenumber.csv'), index=False)
    ...
    has_ssn.to_csv(os.path.join(data_dir, 'Has_SSN.csv'), index=False)
